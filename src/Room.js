...
const Room = () => {
    ...
    useEffect(() => {
        ...
        const streamSuccess = (stream) => {
            ...
            localVideo.current.style.border = '2px solid black';
    ...
    return (
      <div>
        {isProducing && <video playsInline muted autoPlay ref={localVideo} width={400} />}
        <video playsInline muted autoPlay ref={remoteVideo} width={400} />
      </div>
    );
};
